...
async function registerController (req, res) {
    ...
    // perform hashing on password using bcrypt
    // passing values password and salt value
    // means perform hashing 10 times on password
...
async function loginController (req, res) {
    ...
    // perform hashing on password using bcrypt and compare it
    // const hash = crypto.createHash("sha256").update(password).digest("hex")
